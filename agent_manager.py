...
class AgentManager():
    ...
    def check_feedback(self, client: PahoClient, topic: str, event: Event, feedback: dict, task: Task) -> None:
    ...
    def check_response(self, client: PahoClient, topic: str, event: Event, response: dict, task: Task):
